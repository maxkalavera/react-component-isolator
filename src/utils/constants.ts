...
/* UUIDS */
export const LOCAL_STORAGE_CONTEXT_ID =
  "04e7b431-6e23-45df-9314-2798fd459862" as const;
export const SELECTED_ELEMENT_WRAPPER_ID =
  "d44e0ece-2d9a-4a52-94eb-097a831359c3" as const;
